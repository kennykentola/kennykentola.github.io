...
const testimonialsData = [
  ...
  {
    id: 3,
    text: "I had the privilege of collaborating with kennykentola...",
    name: "Dora Zhang",
    position: "Director of Marketing daylight",
    assets: doraImg,
  },
  {
    id: 4,
    text: "kennykentola is a software wizard!",
    name: "Fei Gao",
    position: "Operation Leade",
    assets: feiImg,
  },
  {
    id: 5,
    text: "kennykentola transformed our vision into a reality...",
    name: "adeola ganiyu",
